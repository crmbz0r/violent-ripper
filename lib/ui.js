      ...
      `
        ...
        setupDrag() {
            ...
            document.addEventListener('mouseup', () => {
                if (isDraggingBtn) {
                    // Check if button actually moved
                    const hasMoved = Math.abs(btn.offsetLeft - btnStartX) > DRAG_THRESHOLD || Math.abs(btn.offsetTop - btnStartY) > DRAG_THRESHOLD
